...
ic.use_phoenix = False #use Phoenix stellar atmospheric models. User can only use Kurucz models if NIR magnitudes in H and Ks bands need to be more accurate
...
ic.ebv = 0.0405 #mean value of reddening
...
ic.use_reduced_chi2_leq_2 = True
